...
import { updateVehicle } from '../fetchApi';
...
const UpdateVehicle = () => {
    ...
    const [selectedCat, setSelectedCat] = useState({ value: '', label: searchParams.get('type') });
        ...
        onSubmit: async (values) => {
            ...
            const prepareArgs = () => {
                if (selectedCat.value !== '')
                    return {...values , type : selectedCat.value}
                else
                    return values
            }
            ...
            try {
                ...
                let result = await updateVehicle(searchParams.get('id'), prepareArgs());
        ...
        <>
            <form onSubmit={handleSubmit} className="flex flex-col justify-center w-[800px] py-8 bg-[#70707038] rounded-3xl">
                ...
                <div className="text-xl cursor-pointer flex flex-col justify-center items-center mt-5 md:mt-0">
                    <h1 className="uppercase font-semibold text-3xl text-white m-2 mb-4 tracking-widest">Update Vehicle</h1>
                </div>
                <div className="flex flex-col justify-center items-center mt-10 md:mt-4">
                    <div className='flex flex-row justify-between w-[90%]'>
                        ...
                        <div>
                            ...
                            <p className='my-1 h-6 text-red-500'> {errors.type && touched.type ? errors.type : ''} </p>
                        </div>
                    </div>
                    <div className='flex flex-row justify-between w-[90%]'>
                        {/* vehicle color field */}
