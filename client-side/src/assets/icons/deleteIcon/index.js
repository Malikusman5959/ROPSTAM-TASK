...
function index(props) {
  return (
    <div className='cursor-pointer flex flex-col justify-center items-center' onClick={props.onClick}>
      <svg className="svg-icon p-2 pt-1" width={props.width} viewBox="0 0 20 20">
        <path fill={props.color} d="M7.083,8.25H5.917v7h1.167V8.25z M18.75,3h-5.834V1.25c0-0.323-0.262-0.583-0.582-0.583H7.667
